...
function App() {
  return (
    ...
    //         <h6 className="title">Abhishek Nale</h6>
    //         <h5>Full/MERN Stack Developer</h5>
    //         <p>
    //           I am a skilled Full Stack and Mern Stack Developer with expertise
    //           in Java, React, MongoDB, Express, Socket IO, Spring, JDBC, and
    //           Node.js. Let's build together!
    //         </p>
    ...
    //         </div> */}
    //       </div>
    //       <div className="img-holder">{/* <img src={man} alt="" /> */}</div>
    //     </div>
    //     {/* Header-widget */}
